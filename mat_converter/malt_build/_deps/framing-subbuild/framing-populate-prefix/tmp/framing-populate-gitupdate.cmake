...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/tuan/Projects/ua_spaaro/mat_converter/malt_build/_deps/framing-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/tuan/Projects/ua_spaaro/mat_converter/malt_build/_deps/framing-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
